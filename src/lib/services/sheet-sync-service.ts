  ...
  return Promise.all(
    members.map(async (m): Promise<RosterRow> => {
      ...
      return {
        ...
        outsideCounted: m.breakdown.outsideCounted,
        hoursCompleted: m.earned,
        remaining: m.remaining,
        tutoring: m.breakdown.requirements.tutoring,
        soupKitchen: m.breakdown.requirements.soupKitchen,
        gardening: m.breakdown.requirements.gardening,
        events,
      };
    }),
  );
