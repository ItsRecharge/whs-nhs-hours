...
const field =
  "w-full rounded-2xl border border-gray-200 px-3 py-2.5 text-sm text-gray-900 outline-none focus:border-primary-500 focus:ring-2 focus:ring-primary-200";
    ...
    <>
      <div className="grid gap-4 sm:grid-cols-2">
        <Link href="/officer/officers" className={cardClass}>
          <Users className="mt-0.5 h-5 w-5 shrink-0 text-primary-800" />
          <div>
        ...
        {cards.map((c) => (
          ...
          >
            <c.icon
              className={`mt-0.5 h-5 w-5 shrink-0 ${c.danger ? "text-red-600" : "text-primary-800"}`}
            />
            <div>
        ...
        {opsEnabled && (
          ...
          >
            <Settings className="mt-0.5 h-5 w-5 shrink-0 text-primary-800" />
            <div>
